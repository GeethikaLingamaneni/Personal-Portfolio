...
<div class="w3-grey"><p style="text-align: right;color: white;float: right"><?php echo $mwidth1;?>%</p>
  <div class="w3-container w3-blue w3-center"style="width:<?php echo $mwidth1;?>%;height: 20px;text-align: left"><img src="web.png" height="15px";width="15px"></img> <?php echo $mskill1;?>  </div>
</div><br></div>
<div class="w3-container">
<div class="w3-grey"><p style="text-align: right;color: white;float: right"><?php echo $mwidth2;?>%</p>
  <div class="w3-container w3-red w3-center"style="width:<?php echo $mwidth2;?>%;height: 20px;text-align:left"><img src="python.png" height="15px";width="15px"></img> <?php echo $mskill2;?></div>
</div><br></div>
<div class="w3-container">
<div class="w3-grey"><p style="text-align: right;color: white;float: right"><?php echo $mwidth3;?>%</p>
  <div class="w3-container w3-green w3-center"style="width:<?php echo $mwidth3;?>%;height: 20px;text-align: left;"><img src="java.png" height="15px";width="15px"></img> <?php echo $mskill3;?> </div>
</div><br></div>
<div class="w3-container">
<div class="w3-grey"><p style="text-align: right;color: white;float: right"><?php echo $mwidth4;?>%</p>
  <div class="w3-container w3-orange w3-center"style="width:<?php echo $mwidth4;?>%;height: 20px;text-align: left"> <font color="white" align="left"><img src="c.jpg" height="15px";width="15px"></img> <?php echo $mskill4;?> </font></div>
</div><br></div>
</div>
   
<div class="column" style="text-align: left;height: 240px;padding-right: 30px"><div class="market">TRANSFERABLE SKILLS</div><br>
<div class="w3-container">
<div class="w3-grey"><p style="text-align: right;color: white;float: right"><?php echo $twidth1;?>%</p>
  <div class="w3-container w3-blue w3-center"style="width:<?php echo $twidth1;?>%;height: 20px;text-align: left"> <font color="white"><img src="communication.png" height="15px";width="15px"></img> <?php echo $tskill1;?></font></div>
</div><br></div>

<div class="w3-container">
<div class="w3-grey"><p style="text-align: right;color: white;float: right"><?php echo $twidth2;?>%</p>
  <div class="w3-container w3-red w3-center"style="width:<?php echo $twidth2;?>%;height: 20px;text-align: left"> <font color="white"><img src="team.jpg" height="15px";width="15px"></img> <?php echo $tskill2;?></font></div>
</div><br></div>

<div class="w3-container">
<div class="w3-grey"><p style="text-align: right;color: white;float: right"><?php echo $twidth3;?>%</p>
  <div class="w3-container w3-green w3-center"style="width:<?php echo $twidth3;?>%;height: 20px;text-align: left"> <font color="white"><img src="leadership.png" height="15px";width="15px"></img>  <?php echo $tskill3;?></font></div>
</div><br></div>

<div class="w3-container" >
<div class="w3-grey"><p style="text-align: right;color: white;float: right"><?php echo $twidth4;?>%</p>
  <div class="w3-container w3-orange w3-center"style="width:<?php echo $twidth4;?>%;height: 20px;text-align: left"> <font color="white"><img src="time.jpg" height="15px";width="15px"></img>  Time <?php echo $tskill4;?> </font></div>
</div><br></div>
